...
<div class="container mx-auto">
  <!-- Jumbotron -->
  <div class="bg-gradient-to-r from-blue-500 to-blue-700 text-white text-center p-10 rounded-lg shadow-2xl mt-8">
    ...
    <button type="button"
      class="mt-6 inline-block bg-yellow-500 text-white px-6 py-3 rounded-lg text-lg transition duration-300 hover:bg-green-500 transform hover:-translate-y-1 hover:scale-105 shadow-lg"
  ...
  <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 px-4 mb-6">
